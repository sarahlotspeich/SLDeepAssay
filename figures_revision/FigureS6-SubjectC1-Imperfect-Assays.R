...
# Load data
figureS6A_data = read.csv(file = "https://raw.githubusercontent.com/sarahlotspeich/SLDeepAssay/main/sim_data/subject_c1_imperfect_vary_sens.csv") 
## create Figure S6
...
ggsave(plot_vary_sens, 
       filename = "figures_revision/real_data_plot_imperfect_subjectC1.png", 
       width = 8, height = 4)

# Load data
figureS6B_data = read.csv(file = "https://raw.githubusercontent.com/sarahlotspeich/SLDeepAssay/main/sim_data/subject_c1_imperfect_vary_spec.csv") 
## create Figure S6
...
ggsave(plot_vary_spec, 
       filename = "figures_revision/real_data_plot_imperfect_subjectC1_vary_spec.png", 
       width = 8, height = 4)
