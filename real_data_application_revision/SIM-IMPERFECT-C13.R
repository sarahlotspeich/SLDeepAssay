...
# Define parameters based on Subject C13
subject_params = read.csv(file = "https://raw.githubusercontent.com/sarahlotspeich/SLDeepAssay/main/real_data_application_revision/data/UDSA_MD_C13.csv")
...
# Save results 
try_sens_spec |> 
  write.csv("~/Documents/SLDeepAssay/sim_data/subject_c13_imperfect_vary_sens.csv", 
            row.names = F)
...
# Save results 
try_sens_spec |> 
  write.csv("~/Documents/SLDeepAssay/sim_data/subject_c13_imperfect_vary_spec.csv", 
            row.names = F)
