## Title: Table S1: Single dilution setting simulations (non-constant Tau)

## Date: 2023/07/18

## Author: Sarah Lotspeich

## Purpose: produce a table to summarize simulation data from the single dilution setting (non-constant tau)
